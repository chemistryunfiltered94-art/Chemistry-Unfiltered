  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorCode === "auth/user-not-found" || errorCode === "auth/wrong-password") {
        ...
        setError("অনেকবার চেষ্টা করা হয়েছে। কিছুক্ষণ পর আবার চেষ্টা করো।");
      } else {
        setError("লগইন করতে সমস্যা হয়েছে। আবার চেষ্টা করো।");
      }
    } finally {
      setLoading(false);
    }
      ...
      >
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-3xl p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white text-slate-800 rounded-xl font-medium hover:bg-slate-100 transition-colors mb-6 disabled:opacity-50"
          >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 gradient-bg text-white rounded-xl font-semibold hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {loading ? (
