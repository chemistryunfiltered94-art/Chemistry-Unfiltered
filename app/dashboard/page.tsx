            ...
            {[
              ...
              return (
                <motion.div key={i}
                  ...
                  className="bg-slate-800 border border-slate-700 rounded-2xl p-3 flex flex-col items-start gap-2 min-w-0"
                >
                  <div className={`w-9 h-9 rounded-xl bg-gradient-to-br ${stat.color} flex items-center justify-center flex-shrink-0 shadow-lg`}>
                    <Icon className="w-4 h-4 text-white" />
                  </div>
                  <div className="min-w-0 w-full">
                    <div className="text-xl font-bold gradient-text leading-none">{stat.value}</div>
                    <div className="text-[11px] text-slate-400 mt-1 leading-tight break-words">{stat.label}</div>
                  </div>
                </motion.div>
              );
            })}
